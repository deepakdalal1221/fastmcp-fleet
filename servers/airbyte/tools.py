...
_SID = "airbyte"
_TIMEOUT = 30.0
_BASE = "https://api.airbyte.com/v1"
...
def register_tools(mcp: FastMCP) -> None:
    ...
    async def list_connections(
        ...
        if is_offline():
            items = await local_store.list_all(_SID, "connections")
    ...
    async def trigger_sync(
        ...
        if is_offline():
            n = local_store.next_id(_SID, "airbyte_seq")
            record = {"id": n, "connection_id": connection_id}
